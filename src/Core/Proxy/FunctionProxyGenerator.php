...
use Go\Core\Proxy\Part\InterceptedFunctionGenerator;
...
class FunctionProxyGenerator
{
    ...
    public function __construct(
        ...
        $functionsContent = [];
        $functionAdvices  = $adviceNames[KernelOptions::FUNCTION_PREFIX] ?? [];
    ...
    protected function getJoinpointInvocationBody(ReflectionFunction $function): string
    {
        ...
        $functionAdvices = $this->adviceNames[KernelOptions::FUNCTION_PREFIX][$function->name];
