...
{
    /**
     * Generates child code by original class reflection and joinpoints for it
     *
    ...
    public function __construct(
        ...
        $dynamicMethodAdvices = $traitAdviceNames[KernelOptions::METHOD_PREFIX] ?? [];
        $staticMethodAdvices  = $traitAdviceNames[KernelOptions::STATIC_METHOD_PREFIX] ?? [];
